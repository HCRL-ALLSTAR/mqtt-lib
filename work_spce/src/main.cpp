#include <Arduino.h>
#include "mqttWrapper/mqttWrapper.hpp"
...
{
    Serial.begin(115200);
    _wifiBegin(&WiFi, "MakeEdu3", "Hybrid-6Zero7");
    MqttBegin(&mqtt, "161.246.6.147", 1883, callback);
    AddTopic(topicList, "M5/Test");
}

void loop()
{
    MqttLoop(&mqtt, topicList);
}
// #include <Arduino.h>
// #include "HCRL_EDU.h"
